function byStart(machCODE){
	...
	itemBtnca.onclick = function(){
		...
		for(var i = 0; i < xsty.length; i++){
			...
			xstyCount.push('<div style="font-size: 14px; color: red; margin-bottom: 5px;">Price Multiple Not the same</div>');
...
function ycStart(machCODE,mobleId){
	...
	function remoteXuan(Arra,Arrb,Arrc,Arrd,Arre){
		...
		tda.innerHTML = 'Start：<input class="startTime" type="text" readonly="readonly" value="'+Arra+'"/><div class="startTimeDick"><div class="startTimeDick_left"><div class="startTimeDick_left_top"><b></b></div><div class="startTimeDick_left_center"><input type="number" value="00"/>:</div><div class="startTimeDick_left_bottom"><b></b></div></div><div class="startTimeDick_right"><div class="startTimeDick_right_top"><b></b></div><div class="startTimeDick_right_center"><input type="number" value="00"/></div><div class="startTimeDick_right_bottom"><b></b></div></div><div class="clear"></div><div class="startTimeDick_bottom">确认<div></div>';
		tdb.innerHTML = 'End：<input class="endTime" type="text" readonly="readonly" value="'+Arrb+'"/><div class="endTimeDick"><div class="endTimeDick_left"><div class="endTimeDick_left_top"><b></b></div><div class="endTimeDick_left_center"><input type="number" value="00"/>:</div><div class="endTimeDick_left_bottom"><b></b></div></div><div class="endTimeDick_right"><div class="endTimeDick_right_top"><b></b></div><div class="endTimeDick_right_center"><input type="number" value="00"/></div><div class="endTimeDick_right_bottom"><b></b></div></div><div class="clear"></div><div class="endTimeDick_bottom">确认<div></div>';
